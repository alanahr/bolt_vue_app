...
export default {
  ...
  data() {
    return {
      editor: null,
      // { slug: 'mark', icon: 'fa-solid fa-highlighter', active: 'mark' },
      // { slug: 'heading', icon: 'fa-solid fa-heading', active: 'heading' },
      textActions: [
        { slug: 'bold', icon: 'fa-solid fa-bold', active: 'bold' },
        { slug: 'italic', icon: 'fa-solid fa-italic', active: 'italic' },
        {
          slug: 'underline',
          icon: 'fa-solid fa-underline',
          active: 'underline',
        },
        { slug: 'strike', icon: 'fa-solid fa-strikethrough', active: 'strike' },
        {
          slug: 'align',
          option: 'left',
        ...
        { slug: 'clear', icon: 'fa-solid fa-text-slash', active: 'clear' },
      ],
    };
  },
  computed: {
